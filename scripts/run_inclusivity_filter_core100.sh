...
ENV="roary_env"
IN="pipelines/panaroo/3_inclusivity/core100_identity.tsv"
OUT="pipelines/panaroo/3_inclusivity/core100_candidates.txt"
...
if [[ ! -s "$IN" ]]; then
  ...
  echo "      Run scripts/run_inclusivity_core100.sh first." >&2
  exit 1
fi
