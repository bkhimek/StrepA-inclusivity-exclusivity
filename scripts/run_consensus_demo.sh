...
# Use the inclusivity candidates from Step 3 (core99 + ≥98% identity)
CAND_TSV="pipelines/panaroo/3_inclusivity/demo_core99_candidates.tsv"

# Outputs
OUT_DIR="pipelines/panaroo/4_consensus"
CONS_OUT="${OUT_DIR}/demo_core99_consensus.fasta"
SNP_OUT="${OUT_DIR}/demo_core99_snps.tsv"
PERGENE_OUT="${OUT_DIR}/demo_core99_pergene.tsv"
